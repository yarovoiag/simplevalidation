...
import com.yarovoiag.library.validations.EmptyValidation.Builder
import com.yarovoiag.library.validations.EmptyValidation.Companion.build
 ...
 *
 * @param error Error message if validation field empty
 */
class EmptyValidation(private val error: String) : Validation {
    ...
    class Builder(context: Context) : BaseBuilder(context) {
        ...
        fun build() = EmptyValidation(error)
    }
}